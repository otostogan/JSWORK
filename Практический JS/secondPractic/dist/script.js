...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn', 10);
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical', '', '', 10);
...
const drop = () => {
  ...
  ['dragenter', 'dragover'].forEach(eventName => {
    fileInputs.forEach(input => {
      input.addEventListener(eventName, () => hihglight(input), false);
    });
  });
  ['dragleave', 'dragover'].forEach(eventName => {
    fileInputs.forEach(input => {
      input.addEventListener(eventName, () => unhihglight(input), false);
    });
  });
  fileInputs.forEach(input => {
...
const filter = () => {
  const menu = document.querySelector('.portfolio-menu'),
        ...
        btnGranddadd = menu.querySelector('.granddad'),
  ...
  btnGranddadd.addEventListener('click', () => {
    typeFilter();
  });
...
const forms = () => {
  ...
  upload.forEach(item => {
    item.addEventListener('input', () => {
      ...
      let dots; // 'dasdsadasdasdasdasdaa.jpg' => ['sadasdasdasda', 'jpg']
...
const showMoreStyles = (trigger, wrapper) => {
  ...
  btn.addEventListener('click', function () {
    Object(_services_request__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/styles').then(res => createCards(res)).catch(error => console.error(error));
    this.remove();
  });
